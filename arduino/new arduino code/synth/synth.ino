...
#define LEDbit0 10  // LED's for program selection indication - hook up LED with long lead 
#define LEDbit1 11  // facing the pin and a 1k series resistor to ground
#define LEDbit2 12
#define LEDbit3 13
